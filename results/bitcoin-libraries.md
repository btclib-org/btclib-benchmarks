...
ECDSA sign (32-byte digest, secp256k1)
                               μs/call     vs best
  dsa_sign_pycoin                12.47        1.0x   (50000 calls)
  dsa_sign_embit                 14.23        1.1x   (50000 calls)
  dsa_sign_btclib                19.43        1.6x   (50000 calls)
  dsa_sign_embit_grind           50.28        4.0x   (20000 calls)
  dsa_sign_btclib_grind          64.78        5.2x   (20000 calls)
  dsa_sign_bitcoinlib           194.85       15.6x   (8000 calls)
  dsa_sign_ecdsa                283.03       22.7x   (5000 calls)
  dsa_sign_buidl              30000.72     2406.4x   (50 calls)

ECDSA verify (32-byte digest, secp256k1)
                               μs/call     vs best
  dsa_verify_pycoin              13.02        1.0x   (50000 calls)
  dsa_verify_btclib              23.10        1.8x   (50000 calls)
  dsa_verify_embit               23.23        1.8x   (50000 calls)
  dsa_verify_bitcoinlib         218.52       16.8x   (7000 calls)
  dsa_verify_ecdsa             1092.49       83.9x   (3000 calls)
  dsa_verify_buidl            61296.03     4709.2x   (25 calls)

BIP340 sign (32-byte message)
                               μs/call     vs best
  ssa_sign_embit                 21.76        1.0x   (50000 calls)
  ssa_sign_btclib                22.23        1.0x   (50000 calls)
  ssa_sign_buidl             107824.48     4956.2x   (20 calls)

BIP340 verify (32-byte message)
                               μs/call     vs best
  ssa_verify_embit               24.50        1.0x   (50000 calls)
  ssa_verify_btclib              35.01        1.4x   (50000 calls)
  ssa_verify_buidl            69385.90     2831.9x   (25 calls)

base58check encode, a P2PKH address from a hash160
                               μs/call     vs best
  base58_encode_embit             2.17        1.0x   (200000 calls)
  base58_encode_buidl             2.32        1.1x   (200000 calls)
  base58_encode_btclib            2.43        1.1x   (200000 calls)
  base58_encode_bitcoinlib        2.52        1.2x   (100000 calls)
  base58_encode_pycoin            3.77        1.7x   (200000 calls)

base58check decode, a hash160 from a P2PKH address
                               μs/call     vs best
  base58_decode_embit             2.52        1.0x   (200000 calls)
  base58_decode_btclib            2.54        1.0x   (200000 calls)
  base58_decode_buidl             3.11        1.2x   (200000 calls)
  base58_decode_pycoin            3.80        1.5x   (200000 calls)
  base58_decode_bitcoinlib        4.30        1.7x   (100000 calls)

bech32 encode, a witness-v0 address from a 20-byte program
                               μs/call     vs best
  bech32_encode_btclib            8.35        1.0x   (200000 calls)
  bech32_encode_buidl            11.64        1.4x   (100000 calls)
  bech32_encode_bitcoinlib       26.83        3.2x   (200000 calls)
  bech32_encode_embit            28.70        3.4x   (200000 calls)

bech32 decode, a 20-byte program from a witness-v0 address
                               μs/call     vs best
  bech32_decode_btclib            7.01        1.0x   (200000 calls)
  bech32_decode_buidl            10.47        1.5x   (100000 calls)
  bech32_decode_bitcoinlib       14.62        2.1x   (200000 calls)
  bech32_decode_embit            14.89        2.1x   (200000 calls)

bech32m encode, a witness-v1 address from a 32-byte program
                               μs/call     vs best
  bech32m_encode_btclib          13.32        1.0x   (200000 calls)
  bech32m_encode_buidl           17.13        1.3x   (100000 calls)
  bech32m_encode_embit           39.86        3.0x   (200000 calls)

bech32m decode, a 32-byte program from a witness-v1 address
                               μs/call     vs best
  bech32m_decode_btclib          11.93        1.0x   (200000 calls)
  bech32m_decode_buidl           15.58        1.3x   (100000 calls)
  bech32m_decode_embit           21.97        1.8x   (200000 calls)

BIP32 derive, seed to child, every chain BIP32 publishes
                               μs/call     vs best
  bip32_derive_pycoin            48.73        1.0x   (30000 calls)
  bip32_derive_btclib            63.96        1.3x   (30000 calls)
  bip32_derive_embit             87.98        1.8x   (15000 calls)
  bip32_derive_buidl         107265.47     2201.2x   (12 calls)
```
