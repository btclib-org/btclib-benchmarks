...
ECDSA sign (32-byte digest, secp256k1)
  ...
  dsa_sign_embit                 17.21        1.4x   (50000 calls)
  dsa_sign_btclib                19.45        1.6x   (50000 calls)
  dsa_sign_embit_grind           53.12        4.3x   (20000 calls)
  dsa_sign_btclib_grind          64.59        5.2x   (20000 calls)
  dsa_sign_bitcoinlib           193.24       15.6x   (8000 calls)
  dsa_sign_ecdsa                286.78       23.2x   (5000 calls)
  dsa_sign_buidl              30181.27     2439.5x   (50 calls)

ECDSA verify (32-byte digest, secp256k1)
                               μs/call     vs best
  dsa_verify_pycoin              13.03        1.0x   (50000 calls)
  dsa_verify_embit               23.10        1.8x   (50000 calls)
  dsa_verify_btclib              26.04        2.0x   (50000 calls)
  dsa_verify_bitcoinlib         217.76       16.7x   (7000 calls)
  dsa_verify_ecdsa             1132.25       86.9x   (3000 calls)
  dsa_verify_buidl            62210.69     4774.7x   (25 calls)

BIP340 sign (32-byte message)
                               μs/call     vs best
  ssa_sign_btclib                22.65        1.0x   (50000 calls)
  ssa_sign_embit                 23.02        1.0x   (50000 calls)
  ssa_sign_buidl             109073.92     4815.8x   (20 calls)

BIP340 verify (32-byte message)
                               μs/call     vs best
  ssa_verify_embit               24.29        1.0x   (50000 calls)
  ssa_verify_btclib              36.09        1.5x   (50000 calls)
  ssa_verify_buidl            69411.82     2858.0x   (25 calls)

base58check encode, a P2PKH address from a hash160
                               μs/call     vs best
  base58_encode_embit             2.18        1.0x   (200000 calls)
  base58_encode_btclib            2.47        1.1x   (200000 calls)
  base58_encode_buidl             2.50        1.1x   (200000 calls)
  base58_encode_bitcoinlib        2.54        1.2x   (100000 calls)
  base58_encode_pycoin            3.72        1.7x   (200000 calls)

base58check decode, a hash160 from a P2PKH address
                               μs/call     vs best
  base58_decode_btclib            2.59        1.0x   (200000 calls)
  base58_decode_embit             2.76        1.1x   (200000 calls)
  base58_decode_buidl             2.99        1.2x   (200000 calls)
  base58_decode_pycoin            3.79        1.5x   (200000 calls)
  base58_decode_bitcoinlib        4.58        1.8x   (100000 calls)

bech32 encode, a witness-v0 address from a 20-byte program
                               μs/call     vs best
  bech32_encode_btclib            8.02        1.0x   (200000 calls)
  bech32_encode_buidl            11.65        1.5x   (100000 calls)
  bech32_encode_embit            27.09        3.4x   (200000 calls)
  bech32_encode_bitcoinlib       27.20        3.4x   (200000 calls)

bech32 decode, a 20-byte program from a witness-v0 address
                               μs/call     vs best
  bech32_decode_btclib            7.24        1.0x   (200000 calls)
  bech32_decode_buidl            10.38        1.4x   (100000 calls)
  bech32_decode_bitcoinlib       14.74        2.0x   (200000 calls)
  bech32_decode_embit            15.05        2.1x   (200000 calls)

bech32m encode, a witness-v1 address from a 32-byte program
                               μs/call     vs best
  bech32m_encode_btclib          13.48        1.0x   (200000 calls)
  bech32m_encode_buidl           17.04        1.3x   (100000 calls)
  bech32m_encode_embit           40.36        3.0x   (200000 calls)

bech32m decode, a 32-byte program from a witness-v1 address
                               μs/call     vs best
  bech32m_decode_btclib          11.76        1.0x   (200000 calls)
  bech32m_decode_buidl           15.43        1.3x   (100000 calls)
  bech32m_decode_embit           22.14        1.9x   (200000 calls)

BIP32 derive, seed to child, every chain BIP32 publishes
                               μs/call     vs best
  bip32_derive_pycoin            48.65        1.0x   (30000 calls)
  bip32_derive_btclib            65.04        1.3x   (30000 calls)
  bip32_derive_embit             87.40        1.8x   (15000 calls)
  bip32_derive_buidl         108191.69     2223.7x   (12 calls)
```
